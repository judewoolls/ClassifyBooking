    ...
    if request.method == 'POST':
        try:
            ...
            session = stripe.checkout.Session.create(
                ...
                mode='payment',
                success_url='http://https://classifybooking-2be97a09d742.herokuapp.com//company/checkout/success/',
                cancel_url='http://https://classifybooking-2be97a09d742.herokuapp.com//company/checkout/cancel/',
                metadata={
